...
console.log("Run Automyjsa commands in WebView like this:\n    _automyjsa.run(\"toastLog(\'Hello! The title of this page is: \'+\'\"+document.title+\".\')\"));");
console.log("Or like this:\n    $zips.X('/data/user/0/org.automyjsa.automyjsa/files/sample/WebX(Web控制台中运行)/injected.zip','/sdcard/脚本/'); _automyjsa.run($files.read(\'/sdcard/脚本/injected.js\'));");