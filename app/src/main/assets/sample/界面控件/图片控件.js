...
<scroll>
    <vertical bg="#707070" padding="16">
        ...
        <img src="http://www.automyjsa.org/assets/uploads/profile/3-profileavatar.png"
            w="100" h="100"/>

        <text text="带边框的图片" textColor="black" textSize="16sp" marginTop="16"/>
        <img src="http://www.automyjsa.org/assets/uploads/profile/1-profileavatar.jpeg"
        ...
        <img id="rounded_img" src="http://www.automyjsa.org/assets/uploads/profile/1-profileavatar.jpeg"
...
ui.change_img.on("click", ()=>{
    ui.rounded_img.setSource("http://www.automyjsa.org/assets/uploads/profile/1-profilecover.jpeg");
});